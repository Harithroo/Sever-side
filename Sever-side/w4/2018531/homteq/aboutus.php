...
echo "<title>homteq: app and cloud controlled tech for your home</title>"; //display name of the page as window title
echo "<body>";
include ("headfile.html"); //include header layout file
echo "<h4>homteq: app and cloud controlled tech for your home</h4>"; //display name of the page on the web page
//display random text
